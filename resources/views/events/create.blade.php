...
@section('content')
    ...
    <div id="event-creat-container" class="col-md-6 offset-md-3">
        <form action="/events" method="POST" enctype="multipart/form-data" id="form-create-event">
            <h3 class="text-center mb-0 font-weight-bold">Crie seu evento</h3>
            @csrf
            <div class="mb-3 ">
                <label for="image" class="text-dark">Imagem do evento:</label>
                <input type="file" id="image" name="image" class="form-control-file btn btn-primary">
            </div>
            <div class="form-group">
                <input type="text" class="form-control" id="title" name="title" placeholder="Nome do Evento">
            </div>
            <div class="form-group d-flex">
                <small class="d-flex flex-column justify-content-center text-muted">Data:</small>
            ...
            <div class="form-group">
                <label for="title" class="text-dark">Adicione os items da infraestrutura</label>
                <div class="form-group">
